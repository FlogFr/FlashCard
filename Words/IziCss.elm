...
iconWindowClose : Attribute msg
iconWindowClose =
    css
        [ before
            [ property "content" "\"\xF2D3\""
            , fontFamilies [ "fontello" ]
            , color Css.Colors.white
            ]
        ]


iconEdit : Attribute msg
iconEdit =
    css
        [ before
            [ property "content" "\"\xE831\""
            , fontFamilies [ "fontello" ]
            , color Css.Colors.white
            ]
        ]
...
captionWordH1Css : Attribute msg
captionWordH1Css =
    css
        [ display inlineBlock
        , position relative
...
captionWordLanguageCss : Attribute msg
captionWordLanguageCss =
    css
        [ display inlineBlock
        , position relative
        , border3 (px 2) solid Css.Colors.white
        , width (px 46)
        , margin (px 0)
        , color Css.Colors.white
        ]
