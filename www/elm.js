...
var author$project$Route$modifyUrl = function (theRoute) {
						...
						elm$core$Platform$Cmd$batch(
							_List_fromArray(
								[
									...
									author$project$Route$modifyUrl(author$project$Route$Login)
								])));
				case 'Home':
...
var author$project$WordApp$init = function (flags) {
	var sessionValue = A2(
		...
		A2(
			...
			flags));
	var resultUrlString = A2(
		elm$json$Json$Decode$decodeValue,
		A2(elm$json$Json$Decode$field, 'urlString', elm$json$Json$Decode$string),
		flags);
	var urlString = function () {
		if (resultUrlString.$ === 'Ok') {
			var u = resultUrlString.a;
			return u;
		} else {
			return '';
		}
...
var author$project$WordApp$UrlChanged = function (a) {
	return {$: 'UrlChanged', a: a};
};
var author$project$WordApp$subscriptions = function (model) {
	return author$project$Ports$onUrlChange(author$project$WordApp$UrlChanged);
};
							...
							elm$core$Platform$Cmd$batch(
								_List_fromArray(
									[
										...
										author$project$Route$modifyUrl(author$project$Route$Home)
									]))),
...
var author$project$Page$ProfileEdit$update = F3(
	function (session, msg, model) {
		switch (msg.$) {
			case 'TestMsg':
				return _Utils_Tuple2(
			...
			switch (_n0.b.$) {
				...
				case 'LoginMsg':
					if (_n0.a.$ === 'Login') {
						...
						var subMsg = _n0.b.a;
						var _n1 = A2(author$project$Page$Login$update, subMsg, subModel);
						var _n2 = _n1.a;
						var pageModel = _n2.a;
						var pageMsg = _n2.b;
						var externalMsg = _n1.b;
				...
				case 'RegisterMsg':
					if (_n0.a.$ === 'Register') {
						var subModel = _n0.a.a;
						var subMsg = _n0.b.a;
						var _n6 = A2(author$project$Page$Register$update, subMsg, subModel);
						var _n7 = _n6.a;
						var pageModel = _n7.a;
						var pageMsg = _n7.b;
						var externalMsg = _n6.b;
						if (externalMsg.$ === 'NoOp') {
							return _Utils_Tuple2(
								_Utils_update(
									model,
				...
				case 'ProfileEditMsg':
					if (_n0.a.$ === 'ProfileEdit') {
						var subModel = _n0.a.a;
						var subMsg = _n0.b.a;
						var _n9 = A3(author$project$Page$ProfileEdit$update, model.session, subMsg, subModel);
						var _n10 = _n9.a;
						var pageModel = _n10.a;
						var pageMsg = _n10.b;
						var externalMsg = _n9.b;
						switch (externalMsg.$) {
							case 'NoOp':
								return _Utils_Tuple2(
									_Utils_update(
				...
				case 'HomeInit':
					if (_n0.a.$ === 'Home') {
						...
						var _n12 = A3(
							...
							subModel);
						var _n13 = _n12.a;
						var pageModel = _n13.a;
						var pageMsg = _n13.b;
						var externalMsg = _n12.b;
						switch (externalMsg.$) {
							case 'NoOp':
								return _Utils_Tuple2(
									_Utils_update(
				...
				case 'HomeMsg':
					if (_n0.a.$ === 'Home') {
						var subModel = _n0.a.a;
						var subMsg = _n0.b.a;
						var _n16 = A3(author$project$Page$Home$update, model.session, subMsg, subModel);
						var _n17 = _n16.a;
						var pageModel = _n17.a;
						var pageMsg = _n17.b;
						var externalMsg = _n16.b;
						switch (externalMsg.$) {
							case 'NoOp':
								return _Utils_Tuple2(
									_Utils_update(
				...
				case 'WordEditInitMsg':
					if (_n0.a.$ === 'WordEdit') {
						...
						var _n20 = A3(
							...
							subModel);
						var _n21 = _n20.a;
						var pageModel = _n21.a;
						var pageMsg = _n21.b;
						var externalMsg = _n20.b;
						switch (externalMsg.$) {
							case 'NoOp':
								return _Utils_Tuple2(
									_Utils_update(
				...
				case 'WordEditMsg':
					if (_n0.a.$ === 'WordEdit') {
						var subModel = _n0.a.a;
						var subMsg = _n0.b.a;
						var _n23 = A3(author$project$Page$WordEdit$update, model.session, subMsg, subModel);
						var _n24 = _n23.a;
						var pageModel = _n24.a;
						var pageMsg = _n24.b;
						var externalMsg = _n23.b;
						switch (externalMsg.$) {
							case 'NoOp':
								return _Utils_Tuple2(
									_Utils_update(
				...
				case 'WordDeleteInitMsg':
					if (_n0.a.$ === 'WordDelete') {
						...
						var _n26 = A3(
							...
							subModel);
						var _n27 = _n26.a;
						var pageModel = _n27.a;
						var pageMsg = _n27.b;
						var externalMsg = _n26.b;
						switch (externalMsg.$) {
							case 'NoOp':
								return _Utils_Tuple2(
									_Utils_update(
				...
				case 'QuizzInit':
					if (_n0.a.$ === 'Quizz') {
						...
						var _n29 = A3(
							...
							subModel);
						var _n30 = _n29.a;
						var pageModel = _n30.a;
						var pageMsg = _n30.b;
						var externalMsg = _n29.b;
						return _Utils_Tuple2(
							_Utils_update(
								model,
								{
...
var author$project$Page$Login$view = function (model) {
	return A3(author$project$Views$Forms$viewFormLogin, author$project$Page$Login$LoginTryMsg, author$project$Page$Login$TypeLoginMsg, author$project$Page$Login$TypePasswordMsg);
};
...
var author$project$Page$Register$view = function (model) {
	return A5(author$project$Views$Forms$viewFormRegister, model.newUser, model.nbLanguage, author$project$Page$Register$IncreaseNbLanguage, author$project$Page$Register$UpdateNewUser, author$project$Page$Register$Register);
};
...
var author$project$WordApp$view = function (model) {
	...
	switch (_n0.$) {
		...
		default:
			return frame(author$project$Page$NotFound$view);
	}
};
...
var author$project$WordApp$main = elm$browser$Browser$element(
	{init: author$project$WordApp$init, subscriptions: author$project$WordApp$subscriptions, update: author$project$WordApp$update, view: author$project$WordApp$view});
