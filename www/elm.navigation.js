...
var author$project$Navigation$init = function (flags) {
	var sessionValue = A2(
...
var author$project$Navigation$UrlChanged = function (a) {
...
var author$project$Navigation$subscriptions = function (model) {
	return author$project$Ports$onUrlChange(author$project$Navigation$UrlChanged);
};
var author$project$Navigation$update = F2(
	function (msg, model) {
...
var author$project$Views$Navigation$viewNavigation = function (session) {
...
var author$project$Navigation$view = function (model) {
	return author$project$Views$Navigation$viewNavigation(model.session);
};
...
var author$project$Navigation$main = elm$browser$Browser$element(
	{init: author$project$Navigation$init, subscriptions: author$project$Navigation$subscriptions, update: author$project$Navigation$update, view: author$project$Navigation$view});
_Platform_export({'Navigation':{'init':author$project$Navigation$main(elm$json$Json$Decode$value)(0)}});}(this));