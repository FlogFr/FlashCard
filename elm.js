...
var _user$project$API$getToken = _elm_lang$http$Http$request(
	{
		...
		body: _elm_lang$http$Http$emptyBody,
		expect: _elm_lang$http$Http$expectJson(_user$project$API$decodeToken),
		timeout: _elm_lang$core$Maybe$Nothing,
		withCredentials: false
	});
...
var _user$project$API$encodeNewUser = function (x) {
	return _elm_lang$core$Json_Encode$object(
		{
			ctor: '::',
			_0: {
...
var _user$project$API$encodeUser = function (x) {
	return _elm_lang$core$Json_Encode$object(
		{
			ctor: '::',
			_0: {
...
var _user$project$API$encodeWord = function (x) {
	return _elm_lang$core$Json_Encode$object(
		{
			ctor: '::',
			_0: {
								...
								_0: {
									...
									_1: function (_p7) {
										return A2(
											_elm_lang$core$Maybe$withDefault,
											_elm_lang$core$Json_Encode$null,
											A2(_elm_lang$core$Maybe$map, _elm_lang$core$Json_Encode$int, _p7));
									}(x.difficulty)
								},
								_1: {ctor: '[]'}
							}
...
var _user$project$API$getWordsQuizz = F2(
						...
						_1: {
							...
							_1: {
								...
								_1: {
									...
									_1: {
										ctor: '::',
										_0: _elm_lang$http$Http$encodeUri(keyword),
										_1: {ctor: '[]'}
									}
								}
							}
...
var _user$project$API$getWordsLast = function (headers) {
	return _elm_lang$http$Http$request(
		{
			method: 'GET',
			headers: headers,
...
var _user$project$API$getWordsSearchBySearchWord = F3(
	function (headers, searchWord, searchKeyword) {
		var queryParamsStr = function () {
			var _p8 = searchKeyword;
			if (_p8 === '--') {
				return A2(_elm_lang$core$Basics_ops['++'], 'word=', searchWord);
			} else {
				return A2(
					_elm_lang$core$Basics_ops['++'],
					'word=',
					A2(
						_elm_lang$core$Basics_ops['++'],
						searchWord,
						A2(_elm_lang$core$Basics_ops['++'], '&keyword=', _p8)));
			}
		}();
		var queryParams = A2(_elm_lang$core$Basics_ops['++'], '?', queryParamsStr);
		return _elm_lang$http$Http$request(
			{
				method: 'GET',
				headers: headers,
		...
		return _elm_lang$http$Http$request(
			{
				...
				body: _elm_lang$http$Http$emptyBody,
				expect: _elm_lang$http$Http$expectJson(_user$project$API$decodeWord),
				timeout: _elm_lang$core$Maybe$Nothing,
				withCredentials: false
			});
	});
var _user$project$API$putWordsIdByWordId = F3(
...
var _user$project$API$User = F4(
	function (a, b, c, d) {
		return {userid: a, username: b, email: c, languages: d};
	});
...
var _user$project$API$FullUser = F5(
	function (a, b, c, d, e) {
		return {userid: a, username: b, password: c, email: d, languages: e};
	});
...
var _user$project$API$NewUser = F4(
	function (a, b, c, d) {
		return {username: a, password: b, email: c, languages: d};
	});
		...
		return _elm_lang$http$Http$request(
			{
				...
				body: _elm_lang$http$Http$jsonBody(
					_user$project$API$encodeNewUser(newUser)),
				expect: _elm_lang$http$Http$expectStringResponse(
					function (_p9) {
						var _p10 = _p9;
						return _elm_lang$core$String$isEmpty(_p10.body) ? _elm_lang$core$Result$Ok(_user$project$API$NoContent) : _elm_lang$core$Result$Err('Expected the response body to be empty');
					}),
				timeout: _elm_lang$core$Maybe$Nothing,
				withCredentials: false
			});
		...
		return _elm_lang$http$Http$request(
			{
				...
				expect: _elm_lang$http$Http$expectStringResponse(
					function (_p11) {
						var _p12 = _p11;
						return _elm_lang$core$String$isEmpty(_p12.body) ? _elm_lang$core$Result$Ok(_user$project$API$NoContent) : _elm_lang$core$Result$Err('Expected the response body to be empty');
					}),
				timeout: _elm_lang$core$Maybe$Nothing,
				withCredentials: false
			});
		...
		return _elm_lang$http$Http$request(
			{
				...
				expect: _elm_lang$http$Http$expectStringResponse(
					function (_p13) {
						var _p14 = _p13;
						return _elm_lang$core$String$isEmpty(_p14.body) ? _elm_lang$core$Result$Ok(_user$project$API$NoContent) : _elm_lang$core$Result$Err('Expected the response body to be empty');
					}),
				timeout: _elm_lang$core$Maybe$Nothing,
				withCredentials: false
			});
...
var _user$project$Ports$deleteLocalStorage = _elm_lang$core$Native_Platform.outgoingPort(
	'deleteLocalStorage',
	function (v) {
		return null;
	});
		...
		return _elm_lang$core$Json_Encode$object(
			{
				...
				_0: {
					ctor: '_Tuple2',
					_0: 'user',
					_1: _user$project$API$encodeUser(_p0._0._0)
				},
				_1: {
					ctor: '::',
					_0: {
...
var _user$project$Data_Session$decodeAuthSession = A3(
	_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
	'user',
	_elm_lang$core$Json_Decode$nullable(_user$project$API$decodeUser),
	A3(
		_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
		'authToken',
...
var _user$project$Data_Session$decodeAuthSessionFromJson = function (json) {
	return A2(
		...
		function (_p1) {
			return _elm_lang$core$Result$toMaybe(
				A2(_elm_lang$core$Json_Decode$decodeString, _user$project$Data_Session$decodeAuthSession, _p1));
		},
...
var _user$project$IziCss$captionWordLanguageCss = _rtfeldman$elm_css$Html_Styled_Attributes$css(
	{
		ctor: '::',
...
var _user$project$IziCss$captionWordH1Css = _rtfeldman$elm_css$Html_Styled_Attributes$css(
	{
		ctor: '::',
		_0: _rtfeldman$elm_css$Css$display(_rtfeldman$elm_css$Css$inlineBlock),
		_1: {
...
var _user$project$IziCss$titleCss = _rtfeldman$elm_css$Html_Styled_Attributes$css(
	{
		ctor: '::',
		_0: _rtfeldman$elm_css$Css$margin(
...
var _user$project$IziCss$bottomLogo = _rtfeldman$elm_css$Html_Styled_Attributes$css(
	{
		ctor: '::',
		_0: _rtfeldman$elm_css$Css$width(
...
var _user$project$IziCss$logo = _rtfeldman$elm_css$Html_Styled_Attributes$css(
	{
		ctor: '::',
		_0: _rtfeldman$elm_css$Css$width(
...
var _user$project$IziCss$iconWindowClose = _rtfeldman$elm_css$Html_Styled_Attributes$css(
	{
		ctor: '::',
		_0: _rtfeldman$elm_css$Css$before(
			{
...
var _user$project$IziCss$rightBottomFrame = _rtfeldman$elm_css$Html_Styled_Attributes$css(
	{
		ctor: '::',
...
var _user$project$IziCss$rightHeaderFrame = _rtfeldman$elm_css$Html_Styled_Attributes$css(
	{
		ctor: '::',
		_0: A2(_rtfeldman$elm_css$Css$property, 'grid-area', 'rightheader'),
		_1: {ctor: '[]'}
	});
var _user$project$IziCss$centerHeaderFrame = _rtfeldman$elm_css$Html_Styled_Attributes$css(
	{
		ctor: '::',
		_0: A2(_rtfeldman$elm_css$Css$property, 'grid-area', 'centerheader'),
		_1: {ctor: '[]'}
	});
var _user$project$IziCss$leftHeaderFrame = _rtfeldman$elm_css$Html_Styled_Attributes$css(
	{
		ctor: '::',
		_0: A2(_rtfeldman$elm_css$Css$property, 'grid-area', 'leftheader'),
		_1: {ctor: '[]'}
	});
var _user$project$IziCss$headerFrame = _rtfeldman$elm_css$Html_Styled_Attributes$css(
	{
		ctor: '::',
		_0: A2(_rtfeldman$elm_css$Css$property, 'display', 'grid'),
		_1: {
			ctor: '::',
			_0: A2(_rtfeldman$elm_css$Css$property, 'grid-area', 'header'),
			_1: {
				ctor: '::',
				_0: A2(_rtfeldman$elm_css$Css$property, 'grid-template-columns', '2fr 10fr 2fr'),
				_1: {
					ctor: '::',
					_0: A2(_rtfeldman$elm_css$Css$property, 'grid-template-areas', '\"leftheader   centerheader rightheader\"'),
					_1: {
						ctor: '::',
						_0: _rtfeldman$elm_css$Css$backgroundColor(
...
var _user$project$IziCss$bodyFrame = _rtfeldman$elm_css$Html_Styled_Attributes$css(
	{
		ctor: '::',
		_0: A2(_rtfeldman$elm_css$Css$property, 'display', 'grid'),
		_1: {
			...
			_1: {
				ctor: '::',
				_0: A2(_rtfeldman$elm_css$Css$property, 'grid-template-rows', '1fr auto 100px'),
				_1: {
					ctor: '::',
					...
					_1: {
						...
						_1: {
							...
							_0: _rtfeldman$elm_css$Css$backgroundImage(
								_rtfeldman$elm_css$Css$url('/ressources/waterfalls.jpg')),
							_1: {
								ctor: '::',
...
var _user$project$IziCss$block = _rtfeldman$elm_css$Html_Styled_Attributes$css(
	{
		ctor: '::',
		_0: _rtfeldman$elm_css$Css$margin(
			_rtfeldman$elm_css$Css$px(0)),
...
var _user$project$IziCss$theme = {secondary: _rtfeldman$elm_css$Css_Colors$teal, primary: _rtfeldman$elm_css$Css_Colors$olive};
var _user$project$IziCss$tdBorder = _rtfeldman$elm_css$Html_Styled_Attributes$css(
	{
		ctor: '::',
		_0: A3(
			_rtfeldman$elm_css$Css$border3,
			...
			_rtfeldman$elm_css$Css$solid,
			_user$project$IziCss$theme.secondary),
		_1: {ctor: '[]'}
	});
var _user$project$IziCss$backgroundColored = _rtfeldman$elm_css$Html_Styled_Attributes$css(
	{
		ctor: '::',
		_0: _rtfeldman$elm_css$Css$backgroundColor(_user$project$IziCss$theme.secondary),
		_1: {ctor: '[]'}
	});
var _user$project$IziCss$niceBoxed = _rtfeldman$elm_css$Html_Styled_Attributes$css(
	{
		ctor: '::',
		_0: A3(
			_rtfeldman$elm_css$Css$border3,
			_rtfeldman$elm_css$Css$px(2),
			_rtfeldman$elm_css$Css$solid,
			_user$project$IziCss$theme.primary),
		_1: {
			ctor: '::',
...
var _user$project$IziCss$wordCardCss = _rtfeldman$elm_css$Html_Styled_Attributes$css(
	{
		ctor: '::',
		_0: _rtfeldman$elm_css$Css$display(_rtfeldman$elm_css$Css$inlineBlock),
		_1: {
...
var _user$project$IziCss$captionWordCss = _rtfeldman$elm_css$Html_Styled_Attributes$css(
	{
		ctor: '::',
		_0: _rtfeldman$elm_css$Css$backgroundColor(_user$project$IziCss$theme.primary),
		_1: {ctor: '[]'}
	});
var _user$project$IziCss$btn = A2(
...
var _user$project$Request$getWordsQuizzRequest = F2(
	function (session, keyword) {
		...
		var requestAuthHeader = A2(_elm_lang$http$Http$header, 'Authorization', jwtToken);
		return A2(
			_user$project$API$getWordsQuizz,
			{
				ctor: '::',
				_0: requestAuthHeader,
				_1: {ctor: '[]'}
...
var _user$project$Request$getWordsSearchRequest = F3(
...
var _user$project$Request$getWordsSearchCmd = F4(
	function (msgType, session, searchWord, searchKeyword) {
		return A2(
			_elm_lang$http$Http$send,
			msgType,
			A3(_user$project$Request$getWordsSearchRequest, session, searchWord, searchKeyword));
	});
...
var _user$project$Request$getUserRequest = function (jwtToken) {
	var requestAuthHeader = A2(_elm_lang$http$Http$header, 'Authorization', jwtToken.token);
...
var _user$project$Request$getUserCmd = F2(
	function (msgType, jwtToken) {
		return A2(
			_elm_lang$http$Http$send,
			msgType,
			_user$project$Request$getUserRequest(jwtToken));
	});
...
var _user$project$Route$Quizz = function (a) {
	return {ctor: 'Quizz', _0: a};
};
...
var _user$project$Views_Words$viewWordCard = function (word) {
	return A2(
		_rtfeldman$elm_css$Html_Styled$div,
		{
			ctor: '::',
			_0: _user$project$IziCss$wordCardCss,
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
			_0: A2(
				...
				{
					ctor: '::',
					_0: _user$project$IziCss$captionWordCss,
					_1: {ctor: '[]'}
				},
				{
					ctor: '::',
					_0: A2(
						...
						{
							ctor: '::',
							_0: _user$project$IziCss$captionWordH1Css,
							_1: {ctor: '[]'}
						},
						{
							ctor: '::',
					...
					_1: {
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: _user$project$IziCss$captionWordLanguageCss,
								_1: {ctor: '[]'}
							},
							{
								ctor: '::',
								_0: A2(
									...
									{
										ctor: '::',
										_0: _user$project$IziCss$iconWindowClose,
										_1: {
											ctor: '::',
											_0: _user$project$Route$href(
												_user$project$Route$WordDelete(
								...
								_1: {
									...
									_0: A2(
										...
										{
											ctor: '::',
											_0: _user$project$IziCss$iconEdit,
											_1: {
												ctor: '::',
												_0: _user$project$Route$href(
													_user$project$Route$WordEdit(
...
var _user$project$Views_Words$viewWordsCards = function (words) {
	return A2(
		_rtfeldman$elm_css$Html_Styled$div,
		{ctor: '[]'},
		A2(_elm_lang$core$List$map, _user$project$Views_Words$viewWordCard, words));
};
	...
	return A2(
		...
		{ctor: '[]'},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _user$project$IziCss$tdBorder,
					_1: {ctor: '[]'}
				},
				{
					ctor: '::',
...
var _user$project$Views_Words$viewWordsTable = function (words) {
	return A2(
		...
		{ctor: '[]'},
		{
					...
					_0: A2(
						...
						{ctor: '[]'},
						{
							...
							_0: A2(
								...
								{
									ctor: '::',
									_0: _rtfeldman$elm_css$Html_Styled$text('language'),
									_1: {ctor: '[]'}
								}),
							_1: {
								ctor: '::',
								_0: A2(
									...
									{
										ctor: '::',
										_0: _rtfeldman$elm_css$Html_Styled$text('original'),
										_1: {ctor: '[]'}
									}),
								_1: {
									ctor: '::',
									_0: A2(
										...
										{
											ctor: '::',
											_0: _rtfeldman$elm_css$Html_Styled$text('my translation'),
											_1: {ctor: '[]'}
										}),
									_1: {
										ctor: '::',
										_0: A2(
											...
											{
												ctor: '::',
												_0: _rtfeldman$elm_css$Html_Styled$text('keywords'),
												_1: {ctor: '[]'}
											}),
										_1: {
											ctor: '::',
			...
			_1: {
				...
				_0: A2(
					...
					{ctor: '[]'},
					A2(_elm_lang$core$List$map, _user$project$Views_Words$viewWordTr, words)),
				_1: {ctor: '[]'}
			}
		});
};

var _user$project$Views_Forms$updateNiemeListElement = F3(
	function (nieme, newElem, l) {
		return A2(
			_elm_lang$core$List$append,
			A2(
				_elm_lang$core$List$append,
				A2(_elm_lang$core$List$take, nieme - 1, l),
				{
					ctor: '::',
					_0: newElem,
					_1: {ctor: '[]'}
				}),
			A2(_elm_lang$core$List$drop, nieme, l));
	});
var _user$project$Views_Forms$viewLanguageUserInput = F5(
	function (user, toIncreaseNbLanguage, toUpdateUser, toRemoveLanguage, indexInput) {
		var language = function () {
			var _p0 = _elm_lang$core$List$head(
				A2(_elm_lang$core$List$drop, indexInput, user.languages));
			if (_p0.ctor === 'Just') {
				return _p0._0;
			} else {
				return '';
			...
			{ctor: '[]'},
			{
							...
							function (v) {
								return toUpdateUser(
									_elm_lang$core$Native_Utils.update(
										user,
										{
											languages: A3(_user$project$Views_Forms$updateNiemeListElement, indexInput + 1, v, user.languages)
										}));
							}),
						_1: {
							ctor: '::',
							_0: _rtfeldman$elm_css$Html_Styled_Attributes$placeholder('languages to learn (2chars)'),
							_1: {
								ctor: '::',
								_0: _rtfeldman$elm_css$Html_Styled_Attributes$value(language),
								_1: {ctor: '[]'}
							}
						}
					},
				...
				_1: {
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _rtfeldman$elm_css$Html_Styled_Events$onClick(toIncreaseNbLanguage),
							_1: {
								ctor: '::',
								_0: _rtfeldman$elm_css$Html_Styled_Attributes$type_('button'),
								_1: {ctor: '[]'}
							}
						},
						{
							ctor: '::',
							_0: _rtfeldman$elm_css$Html_Styled$text('(+) Add a language'),
							_1: {ctor: '[]'}
						}),
					_1: {
						ctor: '::',
						_0: A2(
							...
							{
								ctor: '::',
								_0: _rtfeldman$elm_css$Html_Styled$text('(-) Remove language'),
								_1: {ctor: '[]'}
							}),
						_1: {ctor: '[]'}
					}
...
var _user$project$Views_Forms$viewLanguageUserInputs = F5(
	function (numberOfInput, toIncreaseNbLanguage, toRemoveLanguage, user, toUpdateUser) {
		var createLanguageInput = F2(
			function (indexInput, _p1) {
				return A5(_user$project$Views_Forms$viewLanguageUserInput, user, toIncreaseNbLanguage, toUpdateUser, toRemoveLanguage, indexInput);
			});
		return A2(
...
var _user$project$Views_Forms$viewFormUpdateUser = F7(
	function (user, nbLanguage, toIncreaseNbLanguage, toRemoveLanguage, toUpdateNewUser, toUpdateMsg, toUpdatePassword) {
		return A2(
			...
			A2(
				_elm_lang$core$Basics_ops['++'],
				{
					...
					_0: A2(
						_rtfeldman$elm_css$Html_Styled$input,
						{
							...
							_1: {
								ctor: '::',
								_0: _rtfeldman$elm_css$Html_Styled_Events$onInput(toUpdatePassword),
								_1: {
									ctor: '::',
										...
										function (v) {
											return toUpdateNewUser(
												_elm_lang$core$Native_Utils.update(
													user,
													{
														email: _elm_lang$core$Maybe$Just(v)
													}));
										}),
									_1: {
										ctor: '::',
										...
										_1: {
											...
											_0: _rtfeldman$elm_css$Html_Styled_Attributes$value(
												A2(_elm_lang$core$Maybe$withDefault, '', user.email)),
											_1: {ctor: '[]'}
										}
									}
								}
				...
				A2(
					_elm_lang$core$Basics_ops['++'],
					A5(_user$project$Views_Forms$viewLanguageUserInputs, nbLanguage, toIncreaseNbLanguage, toRemoveLanguage, user, toUpdateNewUser),
					{
						ctor: '::',
						_0: A2(
...
var _user$project$Views_Forms$viewLanguageNewUserInput = F4(
							...
							function (v) {
								return toUpdateRegisterModel(
									_elm_lang$core$Native_Utils.update(
										newUser,
										{
											languages: A3(_user$project$Views_Forms$updateNiemeListElement, indexInput + 1, v, newUser.languages)
										}));
							}),
						_1: {
							ctor: '::',
...
var _user$project$Views_Forms$viewLanguageNewUserInputs = F4(
	function (numberOfInput, toIncreaseNbLanguage, newUser, toUpdateRegisterModel) {
		var createLanguageInput = F2(
			function (indexInput, _p2) {
				return A4(_user$project$Views_Forms$viewLanguageNewUserInput, newUser, toIncreaseNbLanguage, toUpdateRegisterModel, indexInput);
			});
		return A2(
			_elm_lang$core$List$indexedMap,
			createLanguageInput,
...
var _user$project$Views_Forms$viewFormRegister = F5(
	function (newUser, nbLanguage, toIncreaseNbLanguage, toUpdateRegisterModel, toRegisterMsg) {
		return A2(
			_rtfeldman$elm_css$Html_Styled$form,
			{
				...
				_1: {
					ctor: '::',
					_0: _rtfeldman$elm_css$Html_Styled_Events$onSubmit(toRegisterMsg),
					_1: {
						ctor: '::',
						_0: _rtfeldman$elm_css$Html_Styled_Attributes$action('javascript:void(0);'),
						_1: {ctor: '[]'}
			...
			A2(
				_elm_lang$core$Basics_ops['++'],
				{
					...
					_0: A2(
						_rtfeldman$elm_css$Html_Styled$input,
						{
							...
							_1: {
								ctor: '::',
								_0: _rtfeldman$elm_css$Html_Styled_Attributes$placeholder('username'),
								_1: {ctor: '[]'}
							}
						},
						{ctor: '[]'}),
					_1: {
						...
						_0: A2(
							_rtfeldman$elm_css$Html_Styled$input,
							{
								...
								_1: {
									ctor: '::',
									_0: _rtfeldman$elm_css$Html_Styled_Attributes$placeholder('password'),
									_1: {
										ctor: '::',
										_0: A2(_rtfeldman$elm_css$Html_Styled_Attributes$attribute, 'type', 'password'),
										_1: {ctor: '[]'}
						...
						_1: {
							...
							_0: A2(
								_rtfeldman$elm_css$Html_Styled$input,
								{
									...
									_1: {
										ctor: '::',
										_0: _rtfeldman$elm_css$Html_Styled_Attributes$placeholder('email'),
										_1: {ctor: '[]'}
									}
								},
								{ctor: '[]'}),
				...
				A2(
					_elm_lang$core$Basics_ops['++'],
					A4(_user$project$Views_Forms$viewLanguageNewUserInputs, nbLanguage, toIncreaseNbLanguage, newUser, toUpdateRegisterModel),
					{
						ctor: '::',
						_0: A2(
							_user$project$IziCss$btn,
			...
			{ctor: '[]'},
			{
							...
							function (v) {
								return toUpdateWord(
									_elm_lang$core$Native_Utils.update(
										word,
										{
											keywords: A3(_user$project$Views_Forms$updateNiemeListElement, indexInput + 1, v, word.keywords)
										}));
							}),
						_1: {
							ctor: '::',
							_0: _rtfeldman$elm_css$Html_Styled_Attributes$placeholder('keyword'),
							_1: {
								ctor: '::',
								_0: _rtfeldman$elm_css$Html_Styled_Attributes$value(keyword),
								_1: {ctor: '[]'}
							}
						}
					},
				...
				_1: {
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _rtfeldman$elm_css$Html_Styled_Events$onClick(toIncreaseNbKeyword),
							_1: {
								ctor: '::',
								_0: _rtfeldman$elm_css$Html_Styled_Attributes$type_('button'),
								_1: {ctor: '[]'}
						...
						{
							ctor: '::',
							_0: _rtfeldman$elm_css$Html_Styled$text('(+) Add a keyword'),
							_1: {ctor: '[]'}
						}),
					_1: {
						ctor: '::',
						_0: A2(
							...
							{
								ctor: '::',
								_0: _rtfeldman$elm_css$Html_Styled$text('(-) Remove keyword'),
								_1: {ctor: '[]'}
							}),
						_1: {ctor: '[]'}
					}
...
var _user$project$Views_Forms$viewKeywordInputs = F5(
	function (numberOfInput, toIncreaseNbKeyword, toRemoveKeyword, word, toUpdateWord) {
		var createWordInput = F2(
			function (indexInput, _p4) {
				return A5(_user$project$Views_Forms$viewKeywordInput, word, toIncreaseNbKeyword, toRemoveKeyword, toUpdateWord, indexInput);
			});
		return A2(
			_elm_lang$core$List$indexedMap,
			createWordInput,
...
var _user$project$Views_Forms$viewWordForm = F6(
	function (word, nbKeyword, toIncreaseNbKeyword, toRemoveKeyword, toUpdateWord, toUpdateMsg) {
		return A2(
			...
			A2(
				_elm_lang$core$Basics_ops['++'],
				{
					...
					_0: A2(
						_rtfeldman$elm_css$Html_Styled$input,
						{
							...
							_1: {
								ctor: '::',
								_0: _rtfeldman$elm_css$Html_Styled_Attributes$placeholder('language'),
								_1: {
									ctor: '::',
									_0: _rtfeldman$elm_css$Html_Styled_Attributes$value(
										function (_) {
					...
					_1: {
						...
						_0: A2(
							_rtfeldman$elm_css$Html_Styled$input,
							{
								...
								_1: {
									ctor: '::',
									_0: _rtfeldman$elm_css$Html_Styled_Attributes$placeholder('definition'),
									_1: {
										ctor: '::',
										_0: _rtfeldman$elm_css$Html_Styled_Attributes$value(
											function (_) {
				...
				A2(
					_elm_lang$core$Basics_ops['++'],
					A5(_user$project$Views_Forms$viewKeywordInputs, nbKeyword, toIncreaseNbKeyword, toRemoveKeyword, word, toUpdateWord),
					{
						ctor: '::',
						_0: A2(
							_rtfeldman$elm_css$Html_Styled$input,
						...
						_1: {
							...
							_0: A2(
								...
								{
									ctor: '::',
									_0: _rtfeldman$elm_css$Html_Styled_Attributes$placeholder('difficulty (0 to 10)'),
									_1: {
										ctor: '::',
										_0: _rtfeldman$elm_css$Html_Styled_Attributes$value(
											_elm_lang$core$Basics$toString(
							...
							_1: {
								...
								_0: A2(
									...
									{
										ctor: '::',
										_0: _rtfeldman$elm_css$Html_Styled$text('Update word'),
										_1: {ctor: '[]'}
									}),
								_1: {ctor: '[]'}
							}
...
var _user$project$Views_Forms$viewFormLogin = F3(
	function (loginTryMsg, typeLoginMsg, typePasswordMsg) {
		return A2(
			_rtfeldman$elm_css$Html_Styled$form,
			{
				...
				_1: {
					ctor: '::',
					_0: _rtfeldman$elm_css$Html_Styled_Events$onSubmit(loginTryMsg),
					_1: {
						ctor: '::',
						_0: _rtfeldman$elm_css$Html_Styled_Attributes$action('javascript:void(0);'),
						_1: {ctor: '[]'}
			...
			},
			{
				...
				_0: A2(
					_rtfeldman$elm_css$Html_Styled$input,
					{
						...
						_1: {
							ctor: '::',
							_0: _rtfeldman$elm_css$Html_Styled_Events$onInput(typeLoginMsg),
							_1: {
								ctor: '::',
								_0: _rtfeldman$elm_css$Html_Styled_Attributes$placeholder('login'),
								_1: {ctor: '[]'}
							}
						}
					},
				...
				_1: {
					...
					_0: A2(
						_rtfeldman$elm_css$Html_Styled$input,
						{
							...
							_1: {
								ctor: '::',
								_0: _rtfeldman$elm_css$Html_Styled_Events$onInput(typePasswordMsg),
								_1: {
									ctor: '::',
									_0: _rtfeldman$elm_css$Html_Styled_Attributes$placeholder('password'),
									_1: {
					...
					_1: {
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: _rtfeldman$elm_css$Html_Styled$text('log-in'),
								_1: {ctor: '[]'}
							}),
						_1: {ctor: '[]'}
					}
...
var _user$project$Views_Forms$viewFormSearchWord = F4(
			...
			},
			{
				...
				_1: {
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _rtfeldman$elm_css$Html_Styled_Events$onInput(toUpdateSearchKeyword),
							_1: {
								ctor: '::',
								_0: _rtfeldman$elm_css$Html_Styled_Attributes$name('keyword'),
								_1: {ctor: '[]'}
							}
						},
						_elm_lang$core$List$concat(
...
var _user$project$Views_Forms$viewFormAddWord = F5(
	function (possibleLanguages, homeAddNewWord, typeHomeLanguage, typeHomeWord, typeHomeDefinition) {
		return A2(
			_rtfeldman$elm_css$Html_Styled$form,
			{
				ctor: '::',
				_0: _rtfeldman$elm_css$Html_Styled_Events$onSubmit(homeAddNewWord),
				_1: {
					ctor: '::',
					_0: _rtfeldman$elm_css$Html_Styled_Attributes$action('javascript:void(0);'),
					_1: {ctor: '[]'}
			...
			},
			{
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _rtfeldman$elm_css$Html_Styled_Events$onInput(typeHomeLanguage),
						_1: {
							ctor: '::',
							_0: _rtfeldman$elm_css$Html_Styled_Attributes$name('language'),
							_1: {ctor: '[]'}
						}
					},
					A2(
						...
						function (l) {
							return A2(
								...
								{
									ctor: '::',
									_0: _rtfeldman$elm_css$Html_Styled$text(l),
									_1: {ctor: '[]'}
								});
						},
						possibleLanguages)),
				_1: {
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _rtfeldman$elm_css$Html_Styled_Events$onInput(typeHomeWord),
							_1: {
								ctor: '::',
								_0: _rtfeldman$elm_css$Html_Styled_Attributes$placeholder('word'),
								_1: {ctor: '[]'}
							}
						},
						{ctor: '[]'}),
					_1: {
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: _rtfeldman$elm_css$Html_Styled_Events$onInput(typeHomeDefinition),
								_1: {
									ctor: '::',
									_0: _rtfeldman$elm_css$Html_Styled_Attributes$placeholder('definition'),
									_1: {ctor: '[]'}
						...
						_1: {
							...
							_0: A2(
								...
								{
									ctor: '::',
									_0: _rtfeldman$elm_css$Html_Styled$text('add word'),
									_1: {ctor: '[]'}
								}),
							_1: {ctor: '[]'}
						}
...
var _user$project$Page_Home$initialModel = function (session) {
	var initialLanguage = function () {
		var _p0 = session.user;
		if (_p0.ctor === 'Just') {
			var _p1 = _elm_lang$core$List$head(_p0._0.languages);
			if (_p1.ctor === 'Just') {
				return _p1._0;
			} else {
				return 'EN';
...
var _user$project$Page_Home$Model = F8(
	function (a, b, c, d, e, f, g, h) {
		return {myLastWords: a, keywords: b, addWordLanguage: c, addWordWord: d, addWordDefinition: e, searchWord: f, searchKeyword: g, searchWords: h};
	});
...
var _user$project$Page_Home$InitFinished = function (a) {
...
var _user$project$Page_Home$UpdateSearchKeyword = function (a) {
	return {ctor: 'UpdateSearchKeyword', _0: a};
};
...
var _user$project$Page_Home$TypeHomeWord = function (a) {
	return {ctor: 'TypeHomeWord', _0: a};
};
var _user$project$Page_Home$TypeHomeLanguage = function (a) {
	return {ctor: 'TypeHomeLanguage', _0: a};
};
var _user$project$Page_Home$HomeAddNewWord = {ctor: 'HomeAddNewWord'};
var _user$project$Page_Home$view = F2(
	function (model, session) {
		var myLangs = function () {
			var _p3 = session.user;
			if (_p3.ctor === 'Just') {
				return _p3._0.languages;
			} else {
				return {
					ctor: '::',
					_0: 'EN',
				...
				_0: A2(
					...
					{ctor: '[]'},
					{
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: _rtfeldman$elm_css$Html_Styled$text('You want to add a word?'),
								_1: {ctor: '[]'}
							}),
						_1: {
							ctor: '::',
							_0: A5(_user$project$Views_Forms$viewFormAddWord, myLangs, _user$project$Page_Home$HomeAddNewWord, _user$project$Page_Home$TypeHomeLanguage, _user$project$Page_Home$TypeHomeWord, _user$project$Page_Home$TypeHomeDefinition),
							_1: {ctor: '[]'}
						}
					}),
				_1: {
					...
					_0: A2(
						...
						{ctor: '[]'},
						{
							...
							_1: {
								ctor: '::',
								_0: A4(
									_user$project$Views_Forms$viewFormSearchWord,
									function (_) {
										return _.keywords;
									}(model),
									_user$project$Page_Home$HomeSearchWord,
									_user$project$Page_Home$UpdateSearchWord,
									_user$project$Page_Home$UpdateSearchKeyword),
								_1: {
									ctor: '::',
						...
						_1: {
							...
							_0: A2(
								...
								{ctor: '[]'},
								{
									...
									_1: {
										ctor: '::',
										_0: _user$project$Views_Words$viewWordsCards(model.myLastWords),
										_1: {ctor: '[]'}
									}
								}),
							_1: {ctor: '[]'}
...
var _user$project$Page_Home$update = F3(
	function (session, msg, model) {
		...
		switch (_p4.ctor) {
			...
			case 'HomeAddNewWord':
				var httpCmd = A3(
					_user$project$Request$postWordCmd,
					_user$project$Page_Home$HomeAddNewWordFinished,
					session,
					A6(
						_user$project$API$Word,
						0,
						function (_) {
							return _.addWordLanguage;
						}(model),
						function (_) {
							return _.addWordWord;
						}(model),
						{ctor: '[]'},
						function (_) {
							return _.addWordDefinition;
						}(model),
						_elm_lang$core$Maybe$Nothing));
				return A2(
					_user$project$Util_ops['=>'],
				...
				if (_p4._0.ctor === 'Ok') {
					return A2(
						...
						A2(
							...
							_elm_lang$core$Native_Utils.update(
								model,
								{myLastWords: _p4._0._0._0, keywords: _p4._0._0._1}),
							_elm_lang$core$Platform_Cmd$none),
						_user$project$Page_Home$NoOp);
				} else {
					return A2(
...
var _user$project$Page_Login$initialModel = {
	...
	username: '',
	userpassword: '',
	jwtToken: _elm_lang$core$Maybe$Nothing
};
var _user$project$Page_Login$Model = F4(
	function (a, b, c, d) {
		return {errors: a, username: b, userpassword: c, jwtToken: d};
	});
var _user$project$Page_Login$LoginRequestUserCompletedMsg = function (a) {
	return {ctor: 'LoginRequestUserCompletedMsg', _0: a};
};
...
var _user$project$Page_Login$TypePasswordMsg = function (a) {
	return {ctor: 'TypePasswordMsg', _0: a};
};
var _user$project$Page_Login$TypeLoginMsg = function (a) {
	return {ctor: 'TypeLoginMsg', _0: a};
};
					...
					return A2(
						...
						A2(
							...
							_elm_lang$core$Native_Utils.update(
								model,
								{
									jwtToken: _elm_lang$core$Maybe$Just(_p1)
								}),
							_elm_lang$core$Platform_Cmd$batch(
								{
									ctor: '::',
									_0: A2(_user$project$Request$getUserCmd, _user$project$Page_Login$LoginRequestUserCompletedMsg, _p1),
									_1: {ctor: '[]'}
								})),
						_user$project$Page_Login$NoOp);
				} else {
...
var _user$project$Page_ProfileEdit$Model = F3(
	function (a, b, c) {
		return {user: a, password: b, nbLanguage: c};
	});
var _user$project$Page_ProfileEdit$initialModel = function (user) {
	return A3(
		_user$project$Page_ProfileEdit$Model,
		user,
		'',
		_elm_lang$core$List$length(user.languages) + 1);
};
...
var _user$project$Page_ProfileEdit$UpdatePassword = function (a) {
	return {ctor: 'UpdatePassword', _0: a};
};
var _user$project$Page_ProfileEdit$RemoveLanguage = function (a) {
	return {ctor: 'RemoveLanguage', _0: a};
};
var _user$project$Page_ProfileEdit$IncreaseNbLanguage = {ctor: 'IncreaseNbLanguage'};
var _user$project$Page_ProfileEdit$view = function (model) {
	return A2(
		...
		{
			ctor: '::',
			_0: A7(_user$project$Views_Forms$viewFormUpdateUser, model.user, model.nbLanguage, _user$project$Page_ProfileEdit$IncreaseNbLanguage, _user$project$Page_ProfileEdit$RemoveLanguage, _user$project$Page_ProfileEdit$UpdateUser, _user$project$Page_ProfileEdit$ToUpdateUser, _user$project$Page_ProfileEdit$UpdatePassword),
			_1: {ctor: '[]'}
		});
};
var _user$project$Page_ProfileEdit$TestMsg = {ctor: 'TestMsg'};
var _user$project$Page_ProfileEdit$UpdateSession = function (a) {
	return {ctor: 'UpdateSession', _0: a};
};
					...
					function (user, indexLanguage) {
						return _elm_lang$core$Native_Utils.update(
							user,
							{
								languages: A2(
									_elm_lang$core$Basics_ops['++'],
									A2(_elm_lang$core$List$take, indexLanguage, user.languages),
									A2(_elm_lang$core$List$drop, indexLanguage + 1, user.languages))
							});
					});
				return A2(
					_user$project$Util_ops['=>'],
					A2(
						...
						_elm_lang$core$Native_Utils.update(
							...
							{
								nbLanguage: model.nbLanguage - 1,
								user: A2(removeLanguage, model.user, _p0._0)
							}),
						_elm_lang$core$Platform_Cmd$none),
					_user$project$Page_ProfileEdit$NoOp);
			case 'ToUpdateUser':
				var languages = function (_) {
					return _.languages;
				}(model.user);
					...
					A2(
						...
						A2(
							...
							A2(
								...
								session,
								A5(_user$project$API$FullUser, 0, username, password, email, languages)))),
					_user$project$Page_ProfileEdit$NoOp);
			default:
				if (_p0._0.ctor === 'Ok') {
					...
					return A2(
						...
						A2(
							...
							_elm_lang$core$Platform_Cmd$batch(
								{
									ctor: '::',
									_0: _user$project$Data_Session$storeSession(newSession),
									_1: {
										ctor: '::',
										_0: _user$project$Route$modifyUrl(_user$project$Route$Home),
										_1: {ctor: '[]'}
						...
						_user$project$Page_ProfileEdit$UpdateSession(newSession));
				} else {
					return A2(
						_user$project$Util_ops['=>'],
						A2(_user$project$Util_ops['=>'], model, _elm_lang$core$Platform_Cmd$none),
...
var _user$project$Page_Quizz$view = function (model) {
	return A2(
		_rtfeldman$elm_css$Html_Styled$div,
		{ctor: '[]'},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _rtfeldman$elm_css$Html_Styled$text('My words for the quizz:'),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
				_0: _user$project$Views_Words$viewWordsCards(
					function (_) {
						return _.words;
					}(model)),
				_1: {ctor: '[]'}
...
var _user$project$Page_Quizz$init = F2(
	function (session, keyword) {
		return _elm_lang$http$Http$toTask(
			A2(_user$project$Request$getWordsQuizzRequest, session, keyword));
	});
var _user$project$Page_Quizz$initialModel = function (keyWord) {
	return {
		errors: {ctor: '[]'},
		words: {ctor: '[]'},
		keyword: keyWord
...
var _user$project$Page_Quizz$Model = F3(
	function (a, b, c) {
		return {errors: a, keyword: b, words: c};
	});
var _user$project$Page_Quizz$QuizzInitFinished = function (a) {
	return {ctor: 'QuizzInitFinished', _0: a};
};
var _user$project$Page_Quizz$TestMsg = {ctor: 'TestMsg'};
var _user$project$Page_Quizz$NoOp = {ctor: 'NoOp'};
var _user$project$Page_Quizz$update = F3(
	function (session, msg, model) {
		var _p0 = msg;
		if (_p0.ctor === 'QuizzInitFinished') {
			if (_p0._0.ctor === 'Ok') {
				return A2(
					_user$project$Util_ops['=>'],
					A2(
...
var _user$project$Page_Register$Model = F4(
	function (a, b, c, d) {
		return {errors: a, token: b, newUser: c, nbLanguage: d};
	});
var _user$project$Page_Register$RegisterFinished = function (a) {
	return {ctor: 'RegisterFinished', _0: a};
};
var _user$project$Page_Register$Register = {ctor: 'Register'};
var _user$project$Page_Register$UpdateNewUser = function (a) {
	return {ctor: 'UpdateNewUser', _0: a};
};
var _user$project$Page_Register$IncreaseNbLanguage = {ctor: 'IncreaseNbLanguage'};
var _user$project$Page_Register$view = function (model) {
	return A2(
		_rtfeldman$elm_css$Html_Styled$div,
		{ctor: '[]'},
		{
			...
			_1: {
				...
				_1: {
					ctor: '::',
					_0: A5(_user$project$Views_Forms$viewFormRegister, model.newUser, model.nbLanguage, _user$project$Page_Register$IncreaseNbLanguage, _user$project$Page_Register$UpdateNewUser, _user$project$Page_Register$Register),
					_1: {ctor: '[]'}
				}
			}
		});
...
var _user$project$Page_WordEdit$initialModel = {word: _elm_lang$core$Maybe$Nothing, nbKeyword: 1};
var _user$project$Page_WordEdit$Model = F2(
	function (a, b) {
		return {word: a, nbKeyword: b};
	});
var _user$project$Page_WordEdit$UpdateWordRequestFinished = function (a) {
	return {ctor: 'UpdateWordRequestFinished', _0: a};
};
var _user$project$Page_WordEdit$UpdateWordRequest = {ctor: 'UpdateWordRequest'};
var _user$project$Page_WordEdit$UpdateWord = function (a) {
	return {ctor: 'UpdateWord', _0: a};
};
var _user$project$Page_WordEdit$WordEditInitFinished = function (a) {
	return {ctor: 'WordEditInitFinished', _0: a};
};
var _user$project$Page_WordEdit$RemoveKeyword = function (a) {
	return {ctor: 'RemoveKeyword', _0: a};
};
var _user$project$Page_WordEdit$IncreaseNbKeyword = {ctor: 'IncreaseNbKeyword'};
var _user$project$Page_WordEdit$view = function (model) {
	var _p0 = model.word;
	if (_p0.ctor === 'Nothing') {
		return A2(
			_rtfeldman$elm_css$Html_Styled$div,
			{ctor: '[]'},
			{
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _rtfeldman$elm_css$Html_Styled$text('Loading the word…'),
						_1: {ctor: '[]'}
					}),
				_1: {ctor: '[]'}
			});
		...
		return A2(
			...
			{ctor: '[]'},
			{
				...
				_1: {
					ctor: '::',
					_0: A6(_user$project$Views_Forms$viewWordForm, _p1, model.nbKeyword, _user$project$Page_WordEdit$IncreaseNbKeyword, _user$project$Page_WordEdit$RemoveKeyword, _user$project$Page_WordEdit$UpdateWord, _user$project$Page_WordEdit$UpdateWordRequest),
					_1: {ctor: '[]'}
				}
			});
	}
							...
							return _elm_lang$core$Maybe$Just(
								_elm_lang$core$Native_Utils.update(
									_p4,
									{
										keywords: A2(
											_elm_lang$core$Basics_ops['++'],
											A2(_elm_lang$core$List$take, indexKeyword, _p4.keywords),
											A2(_elm_lang$core$List$drop, indexKeyword + 1, _p4.keywords))
									}));
						} else {
							return word;
						}
				...
				return A2(
					...
					A2(
						...
						_elm_lang$core$Native_Utils.update(
							...
							{
								nbKeyword: model.nbKeyword - 1,
								word: A2(removeKeyword, model.word, _p2._0)
							}),
						_elm_lang$core$Platform_Cmd$none),
					_user$project$Page_WordEdit$NoOp);
			case 'UpdateWord':
				return A2(
					...
					A2(
						...
						_elm_lang$core$Native_Utils.update(
							model,
							{
								word: _elm_lang$core$Maybe$Just(_p2._0)
							}),
						_elm_lang$core$Platform_Cmd$none),
					_user$project$Page_WordEdit$NoOp);
					...
					return A2(
						...
						A2(
							...
							_elm_lang$core$Native_Utils.update(
								model,
								{
									word: _elm_lang$core$Maybe$Just(_p6),
									nbKeyword: _elm_lang$core$List$length(_p6.keywords) + 1
								}),
							_elm_lang$core$Platform_Cmd$none),
						_user$project$Page_WordEdit$NoOp);
				}
				...
				if (_p7.ctor === 'Nothing') {
					...
					return A2(
						...
						A2(
							_user$project$Util_ops['=>'],
							model,
							A3(_user$project$Request$putWordsIdByWordIdCmd, _user$project$Page_WordEdit$UpdateWordRequestFinished, session, _p7._0)),
						_user$project$Page_WordEdit$NoOp);
				}
			default:
				if (_p2._0.ctor === 'Ok') {
					return A2(
						...
						A2(
							...
							_elm_lang$core$Native_Utils.update(
								model,
								{
									word: _elm_lang$core$Maybe$Just(_p2._0._0)
								}),
							_elm_lang$core$Platform_Cmd$none),
		...
		return A2(
			...
			{ctor: '[]'},
			{
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _rtfeldman$elm_css$Html_Styled$text('Go home'),
						_1: {ctor: '[]'}
					}),
				_1: {
					ctor: '::',
...
var _user$project$Views_Page$viewRightFooter = A2(
	_rtfeldman$elm_css$Html_Styled$div,
	{
		ctor: '::',
		_0: _user$project$IziCss$rightBottomFrame,
		_1: {ctor: '[]'}
	},
	{
		ctor: '::',
...
var _user$project$Views_Page$viewFooter = A2(
	...
	{
		ctor: '::',
		_0: _user$project$IziCss$bottomFrame,
		_1: {ctor: '[]'}
	},
	{
		ctor: '::',
		...
		_1: {
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _user$project$IziCss$bottomLogo,
					_1: {
						ctor: '::',
						_0: _rtfeldman$elm_css$Html_Styled_Attributes$src('/ressources/haskell-logo.png'),
						_1: {ctor: '[]'}
					}
				},
				{ctor: '[]'}),
			_1: {
				...
				_0: A2(
					_rtfeldman$elm_css$Html_Styled$img,
					{
						...
						_1: {
							ctor: '::',
							_0: _rtfeldman$elm_css$Html_Styled_Attributes$src('/ressources/servant-logo.png'),
							_1: {ctor: '[]'}
						}
					},
					{ctor: '[]'}),
				_1: {
					...
					_0: A2(
						_rtfeldman$elm_css$Html_Styled$img,
						{
							...
							_1: {
								ctor: '::',
								_0: _rtfeldman$elm_css$Html_Styled_Attributes$src('/ressources/postgresql-logo.png'),
								_1: {ctor: '[]'}
							}
						},
						{ctor: '[]'}),
					_1: {
						...
						_0: A2(
							_rtfeldman$elm_css$Html_Styled$img,
							{
								...
								_1: {
									ctor: '::',
									_0: _rtfeldman$elm_css$Html_Styled_Attributes$src('/ressources/elm-logo.png'),
									_1: {ctor: '[]'}
								}
							},
							{ctor: '[]'}),
						_1: {
							...
							_0: A2(
								_rtfeldman$elm_css$Html_Styled$img,
								{
									...
									_1: {
										ctor: '::',
										_0: _rtfeldman$elm_css$Html_Styled_Attributes$src('/ressources/debian-logo.png'),
										_1: {ctor: '[]'}
									}
								},
								{ctor: '[]'}),
...
var _user$project$Views_Page$viewHeader = function (session) {
	return A2(
		...
		{
			ctor: '::',
			_0: _user$project$IziCss$headerFrame,
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
			_0: A2(
				...
				{
					ctor: '::',
					_0: _user$project$IziCss$leftHeaderFrame,
					_1: {ctor: '[]'}
				},
				{ctor: '[]'}),
			_1: {
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _user$project$IziCss$centerHeaderFrame,
						_1: {ctor: '[]'}
					},
					{
						ctor: '::',
						_0: A2(
							...
							{
								ctor: '::',
								_0: _user$project$IziCss$titleCss,
								_1: {ctor: '[]'}
							},
							{
								ctor: '::',
								_0: A2(
									...
									{
										ctor: '::',
										_0: _user$project$IziCss$logo,
										_1: {
											ctor: '::',
											_0: _rtfeldman$elm_css$Html_Styled_Attributes$src('/ressources/dictionnary.logo.png'),
											_1: {ctor: '[]'}
										}
									},
									{ctor: '[]'}),
								_1: {
									ctor: '::',
									_0: _rtfeldman$elm_css$Html_Styled$text('IziDict.com'),
									_1: {ctor: '[]'}
								}
							}),
						_1: {ctor: '[]'}
...
var _user$project$Views_Page$frame = F3(
	function (session, listMessages, content) {
		return A2(
			...
			{
				ctor: '::',
				_0: _user$project$IziCss$bodyFrame,
				_1: {ctor: '[]'}
			},
			{
				ctor: '::',
				_0: _user$project$Views_Page$viewHeader(session),
				_1: {
					ctor: '::',
					_0: A2(
						_rtfeldman$elm_css$Html_Styled$div,
...
var _user$project$WordApp$Quizz = function (a) {
	return {ctor: 'Quizz', _0: a};
};
...
var _user$project$WordApp$Login = function (a) {
...
var _user$project$WordApp$QuizzInit = function (a) {
	return {ctor: 'QuizzInit', _0: a};
};
...
var _user$project$WordApp$WordEditInitMsg = function (a) {
	return {ctor: 'WordEditInitMsg', _0: a};
};
var _user$project$WordApp$HomeMsg = function (a) {
...
var _user$project$WordApp$setRoute = F2(
			...
			switch (_p0._0.ctor) {
						...
						_elm_lang$core$Native_Utils.update(
							model,
							{
								page: _user$project$WordApp$ProfileEdit(
									_user$project$Page_ProfileEdit$initialModel(user))
							}),
						_elm_lang$core$Platform_Cmd$none);
				case 'Logout':
					return A2(
				...
				case 'Home':
					var newModel = _elm_lang$core$Native_Utils.update(
						model,
						{
							page: _user$project$WordApp$Home(
								_user$project$Page_Home$initialModel(model.session))
						});
				...
				default:
					...
					return A2(
						...
						_elm_lang$core$Native_Utils.update(
							model,
							{
								page: _user$project$WordApp$Quizz(
									_user$project$Page_Quizz$initialModel(_p6))
							}),
						A2(
							_elm_lang$core$Task$attempt,
							_user$project$WordApp$QuizzInit,
							A2(
								_user$project$Page_Quizz$init,
								function (_) {
									return _.session;
								}(model),
								_p6)));
...
var _user$project$WordApp$init = F2(
...
var _user$project$WordApp$RegisterMsg = function (a) {
	return {ctor: 'RegisterMsg', _0: a};
};
var _user$project$WordApp$LoginMsg = function (a) {
		...
		case 'Login':
			return _rtfeldman$elm_css$Html_Styled$toUnstyled(
				A2(
					...
					frame(
						_user$project$Page_Login$view(_p7._0))));
		case 'Register':
			return _rtfeldman$elm_css$Html_Styled$toUnstyled(
				A2(
					_rtfeldman$elm_css$Html_Styled$map,
					...
					frame(
						_user$project$Page_Register$view(_p7._0))));
		case 'ProfileEdit':
			return _rtfeldman$elm_css$Html_Styled$toUnstyled(
				A2(
					_rtfeldman$elm_css$Html_Styled$map,
					...
					frame(
						_user$project$Page_ProfileEdit$view(_p7._0))));
		case 'Home':
			return _rtfeldman$elm_css$Html_Styled$toUnstyled(
				A2(
					_rtfeldman$elm_css$Html_Styled$map,
					...
					frame(
						A2(_user$project$Page_Home$view, _p7._0, model.session))));
		case 'WordEdit':
			return _rtfeldman$elm_css$Html_Styled$toUnstyled(
				A2(
					_rtfeldman$elm_css$Html_Styled$map,
					...
					frame(
						_user$project$Page_WordEdit$view(_p7._0))));
		case 'WordDelete':
			return _rtfeldman$elm_css$Html_Styled$toUnstyled(
				A2(
					_rtfeldman$elm_css$Html_Styled$map,
					...
					frame(
						_user$project$Page_WordDelete$view(_p7._0))));
		case 'Quizz':
			return _rtfeldman$elm_css$Html_Styled$toUnstyled(
				A2(
					_rtfeldman$elm_css$Html_Styled$map,
					_user$project$WordApp$QuizzMsg,
					frame(
						_user$project$Page_Quizz$view(_p7._0))));
		default:
			return _rtfeldman$elm_css$Html_Styled$toUnstyled(
				frame(_user$project$Page_NotFound$view));
	}
};
var _user$project$WordApp$updatePage = F3(
	function (page, msg, model) {
		var _p8 = {ctor: '_Tuple2', _0: page, _1: msg};
		_v6_12:
		do {
			switch (_p8._1.ctor) {
				case 'SetRoute':
					return A2(_user$project$WordApp$setRoute, _p8._1._0, model);
				case 'LoginMsg':
					if (_p8._0.ctor === 'Login') {
						var _p9 = A2(_user$project$Page_Login$update, _p8._1._0, _p8._0._0);
						var pageModel = _p9._0._0;
						var pageMsg = _p9._0._1;
						var externalMsg = _p9._1;
						var newModel = function () {
							var _p10 = externalMsg;
							if (_p10.ctor === 'NoOp') {
								return model;
							} else {
								return _elm_lang$core$Native_Utils.update(
						...
						return A2(
							...
							_elm_lang$core$Native_Utils.update(
								newModel,
								{
									page: _user$project$WordApp$Login(pageModel)
								}),
				...
				case 'RegisterInit':
					if (_p8._0.ctor === 'Register') {
						var _p11 = A2(
							_user$project$Page_Register$update,
							_user$project$Page_Register$InitFinished(_p8._1._0),
							_p8._0._0);
				...
				case 'RegisterMsg':
					if (_p8._0.ctor === 'Register') {
						var _p12 = A2(_user$project$Page_Register$update, _p8._1._0, _p8._0._0);
				...
				case 'ProfileEditMsg':
					if (_p8._0.ctor === 'ProfileEdit') {
						var _p14 = A3(_user$project$Page_ProfileEdit$update, model.session, _p8._1._0, _p8._0._0);
						var pageModel = _p14._0._0;
						var pageMsg = _p14._0._1;
						var externalMsg = _p14._1;
						var _p15 = externalMsg;
						switch (_p15.ctor) {
							case 'NoOp':
								return A2(
									_user$project$Util_ops['=>'],
				...
				case 'HomeMsg':
					if (_p8._0.ctor === 'Home') {
						var _p19 = A3(_user$project$Page_Home$update, model.session, _p8._1._0, _p8._0._0);
				...
				case 'WordEditInitMsg':
					if (_p8._0.ctor === 'WordEdit') {
						var _p22 = A3(
							_user$project$Page_WordEdit$update,
							model.session,
							_user$project$Page_WordEdit$WordEditInitFinished(_p8._1._0),
							_p8._0._0);
				...
				case 'WordEditMsg':
					if (_p8._0.ctor === 'WordEdit') {
						var _p24 = A3(_user$project$Page_WordEdit$update, model.session, _p8._1._0, _p8._0._0);
						var pageModel = _p24._0._0;
						var pageMsg = _p24._0._1;
						var externalMsg = _p24._1;
						var _p25 = externalMsg;
						switch (_p25.ctor) {
							case 'NoOp':
								return A2(
									_user$project$Util_ops['=>'],
				...
				case 'WordDeleteInitMsg':
					if (_p8._0.ctor === 'WordDelete') {
						var _p26 = A3(
							_user$project$Page_WordDelete$update,
							model.session,
							_user$project$Page_WordDelete$WordDeleteInitFinished(_p8._1._0),
							_p8._0._0);
						var pageModel = _p26._0._0;
						var pageMsg = _p26._0._1;
						var externalMsg = _p26._1;
						var _p27 = externalMsg;
						switch (_p27.ctor) {
							case 'NoOp':
								return A2(
									_user$project$Util_ops['=>'],
				...
				case 'QuizzInit':
					if (_p8._0.ctor === 'Quizz') {
						var _p28 = A3(
							_user$project$Page_Quizz$update,
							model.session,
							_user$project$Page_Quizz$QuizzInitFinished(_p8._1._0),
							_p8._0._0);
						var pageModel = _p28._0._0;
						var pageMsg = _p28._0._1;
						var externalMsg = _p28._1;
						return A2(
							_user$project$Util_ops['=>'],
							_elm_lang$core$Native_Utils.update(
								model,
								{
									page: _user$project$WordApp$Quizz(pageModel)
								}),
							_elm_lang$core$Platform_Cmd$none);
					} else {
						break _v6_12;
...
var _user$project$WordApp$update = F2(
	function (msg, model) {
		return A3(
			_user$project$WordApp$updatePage,
			function (_) {
				return _.page;
			}(model),
			msg,
...
var _user$project$WordApp$SetRoute = function (a) {
...
var _user$project$WordApp$main = A2(
	...
	function (_p29) {
		return _user$project$WordApp$SetRoute(
			_user$project$Route$fromLocation(_p29));
	},
...
if (typeof _user$project$WordApp$main !== 'undefined') {
    _user$project$WordApp$main(Elm['WordApp'], 'WordApp', {"types":{"unions":{"Dict.LeafColor":{"args":[],"tags":{"LBBlack":[],"LBlack":[]}},"Page.WordDelete.Msg":{"args":[],"tags":{"WordDeleteInitFinished":["Result.Result Http.Error API.NoContent"]}},"Page.ProfileEdit.Msg":{"args":[],"tags":{"RemoveLanguage":["Int"],"IncreaseNbLanguage":[],"TestMsg":[],"UpdateUser":["API.User"],"ToUpdateUser":[],"UpdateUserRequestFinished":["Result.Result Http.Error API.User"],"UpdatePassword":["String"]}},"Dict.Dict":{"args":["k","v"],"tags":{"RBNode_elm_builtin":["Dict.NColor","k","v","Dict.Dict k v","Dict.Dict k v"],"RBEmpty_elm_builtin":["Dict.LeafColor"]}},"Route.Route":{"args":[],"tags":{"Home":[],"ProfileEdit":[],"WordEdit":["Int"],"Logout":[],"Register":[],"WordDelete":["Int"],"Quizz":["String"],"Login":[]}},"API.NoContent":{"args":[],"tags":{"NoContent":[]}},"Maybe.Maybe":{"args":["a"],"tags":{"Just":["a"],"Nothing":[]}},"Page.Home.InitModel":{"args":[],"tags":{"InitModel":["List API.Word","List String"]}},"Page.Errored.PageLoadError":{"args":[],"tags":{"PageLoadError":[]}},"Page.Quizz.Msg":{"args":[],"tags":{"QuizzInitFinished":["Result.Result Http.Error (List API.Word)"],"TestMsg":[]}},"Dict.NColor":{"args":[],"tags":{"BBlack":[],"Red":[],"NBlack":[],"Black":[]}},"Page.Home.Msg":{"args":[],"tags":{"HomeAddNewWord":[],"HomeSearchWord":[],"TypeHomeLanguage":["String"],"LastWordsReqCompletedMsg":["Result.Result Http.Error (List API.Word)"],"HomeAddNewWordFinished":["Result.Result Http.Error API.NoContent"],"UpdateSearchKeyword":["String"],"TestMsg":[],"TypeHomeDefinition":["String"],"HomeSearchWordFinished":["Result.Result Http.Error (List API.Word)"],"InitFinished":["Result.Result Page.Errored.PageLoadError Page.Home.InitModel"],"TypeHomeWord":["String"],"UpdateSearchWord":["String"]}},"Page.WordEdit.Msg":{"args":[],"tags":{"UpdateWordRequestFinished":["Result.Result Http.Error API.Word"],"RemoveKeyword":["Int"],"UpdateWordRequest":[],"IncreaseNbKeyword":[],"TestMsg":[],"UpdateWord":["API.Word"],"WordEditInitFinished":["Result.Result Http.Error API.Word"]}},"WordApp.Msg":{"args":[],"tags":{"WordDeleteInitMsg":["Result.Result Http.Error API.NoContent"],"QuizzMsg":["Page.Quizz.Msg"],"LoginMsg":["Page.Login.Msg"],"HomeInit":["Result.Result Page.Errored.PageLoadError Page.Home.InitModel"],"SetRoute":["Maybe.Maybe Route.Route"],"WordEditMsg":["Page.WordEdit.Msg"],"RegisterInit":["Result.Result Http.Error String"],"HomeMsg":["Page.Home.Msg"],"ProfileEditMsg":["Page.ProfileEdit.Msg"],"WordEditInitMsg":["Result.Result Http.Error API.Word"],"QuizzInit":["Result.Result Http.Error (List API.Word)"],"RegisterMsg":["Page.Register.Msg"],"WordDeleteMsg":["Page.WordDelete.Msg"]}},"Page.Register.Msg":{"args":[],"tags":{"IncreaseNbLanguage":[],"Register":[],"UpdateNewUser":["API.NewUser"],"InitFinished":["Result.Result Http.Error String"],"RegisterFinished":["Result.Result Http.Error API.NoContent"]}},"Http.Error":{"args":[],"tags":{"BadUrl":["String"],"NetworkError":[],"Timeout":[],"BadStatus":["Http.Response String"],"BadPayload":["String","Http.Response String"]}},"Result.Result":{"args":["error","value"],"tags":{"Ok":["value"],"Err":["error"]}},"Page.Login.Msg":{"args":[],"tags":{"TypePasswordMsg":["String"],"LoginRequestUserCompletedMsg":["Result.Result Http.Error API.User"],"TypeLoginMsg":["String"],"LoginTryMsg":[],"LoginGrantCompletedMsg":["Result.Result Http.Error API.JWTToken"]}}},"aliases":{"API.User":{"args":[],"type":"{ userid : Int , username : String , email : Maybe.Maybe String , languages : List String }"},"Http.Response":{"args":["body"],"type":"{ url : String , status : { code : Int, message : String } , headers : Dict.Dict String String , body : body }"},"API.Word":{"args":[],"type":"{ id : Int , language : String , word : String , keywords : List String , definition : String , difficulty : Maybe.Maybe Int }"},"API.JWTToken":{"args":[],"type":"{ token : String }"},"API.NewUser":{"args":[],"type":"{ username : String , password : String , email : Maybe.Maybe String , languages : List String }"}},"message":"WordApp.Msg"},"versions":{"elm":"0.18.0"}});
}
